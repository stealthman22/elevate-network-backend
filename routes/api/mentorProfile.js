...
// @access  Private
router.get('/mentor-user/:user_id', [auth, partnerSwitch], async (req, res) => {
  try {
...
// @access  Private
router.get('/mentee-user/:user_id', [auth, partnerSwitch], async (req, res) => {
  try {
...
// @access  Private
router.get('/partner-user/:user_id', [auth, partnerSwitch], async (req, res) => {
  try {
...
// @access  Private
router.put('/education', [auth, partnerSwitch], [
...
// @access  Private
router.delete('/education/:edu_id', [auth, partnerSwitch], async (req, res) => {
  const profile = await MentorProfile.findOne({ user: req.user.id });
  try {
    // grab the index
...
// @access  Private
router.put('/experience', [auth, partnerSwitch],
  [
...
// @access  Private
router.delete('/experience/:exp_id', [auth, partnerSwitch], async (req, res) => {
  try {
    const profile = await MentorProfile.findOne({ user: req.user.id });
